...
var components = exports.components = {
	...
	tell: function (target, room, user) {
		...
		tells[toId(this.targetUsername)].push(Date().toLocaleString() + "|raw|- <b>" + user.getIdentity() + "</b> said: <font face=\"Lucida Console\">" + Tools.escapeHTML(message) + "</font>";
		return this.sendReply("Message \"<font face=\"Lucida Console\">" + message + "</font>\" sent to " + this.targetUsername + ".");
	},
