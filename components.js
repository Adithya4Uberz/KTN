...
var components = exports.components = {
    ...
    earnmoney: function (target, room, user) {
        ...
        this.sendReplyBox('<b><font color=green>You can earn bucks by:</font></b><li>Competing in various Tournaments throughout the Server\'s official rooms.<br />' +
                 ...
                 '<li>Follow <a href="https://github.com/macrarazy/"><b>'/*<font color="'+hashColor(''+toId(macrarazy)+'')+'">macrarazy</font>*/'macrarazy</b></a>, <a href="https://github.com/CreaturePhil/"><b>'/*<font color="'+hashColor(''+toId(CreaturePhil)+'')+'">CreaturePhil</font>*/'CreaturePhil</b></a> and <a href="https://github.com/BlakJack/"><b>'/*<font color="'+hashColor(''+toId(BlakJack)+'')+'">BlakJack</font>*/'BlakJack</b></a> on GitHub unless <a href="https://github.com/register/"><b>you don\'t have a GitHub account</b></a>.</li>' +
